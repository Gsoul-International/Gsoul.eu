...
class BFiles extends Module{
  ...
  public function Main(){
    ...
    $action=getget('action','list-images');
      if($action=='list-files'){$this->PageListFiles();}
      elseif($action=='file-category-new-post'){$this->FileCategoryNewPost();}   
      elseif($action=='delete-file-category'){$this->FileCategoryDeletePost();}                                                              
      elseif($action=='edit-file-category'){$this->FileCategoryEdit();}
      elseif($action=='file-save-category-post'){$this->FileCategoryEditPost();} 
      elseif($action=='file-new-post'){$this->FileNewPost();}  
      elseif($action=='save-file'){$this->SaveFilePost();}  
      elseif($action=='delete-file'){$this->DeleteFilePost();}                                                                                           
      elseif($action=='image-category-new-post'){$this->ImageCategoryNewPost();}   
      elseif($action=='delete-image-category'){$this->ImageCategoryDeletePost();}                                                              
      elseif($action=='list-images'){$this->PageListImages();}      
      elseif($action=='edit-image-category'){$this->ImageCategoryEdit();} 
      elseif($action=='image-new-post'){$this->ImageNewPost();}
      elseif($action=='image-new-post-2'){$this->ImageNewPost2();}                                                            
      elseif($action=='delete-image'){$this->DeleteImagePost();}      
      elseif($action=='save-image'){$this->SaveImagePost();}                                                                                     
      elseif($action=='image-save-category-post'){$this->ImageCategoryEditPost();} 
      else{$this->Redirect();}        
    }
  /*
  * Levý sloupec
