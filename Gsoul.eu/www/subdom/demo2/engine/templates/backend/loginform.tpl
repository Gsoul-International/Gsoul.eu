          ...
          <table align="center" width="100%" class="LoginTable">
            <tr>
              <td align="center" valign="center">
                <a title="MHMSYS s.r.o." href="http://www.mhmsys.cz" target="_blank"><img src="/img/mhmsys.png" alt="MHMSYS s.r.o." /></a>
                <h1>MHMcube přihlášení</h1>                               
              </td>
            </tr>                          
            ...
            <tr>
              <td align="center" valign="center">                          
                Administrační systém <span class="bluetext">MHMcube</span> od společnosti <a href="http://www.mhmsys.cz" target="_blank">MHMSYS s.r.o.</a> © 2015 - <?=strftime('%Y',time());?>.          
              </td>        
            </tr>
          </table>
        </div>
