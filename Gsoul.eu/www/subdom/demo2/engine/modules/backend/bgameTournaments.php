...
class BGameTournaments extends Module{
  ...
  public function PageMain(){    
    ...
    if($filter->f_odmeneno==1){$andGroup[]=' prerozdelene_vyhry=1 ';}        
    if($filter->f_odmeneno==2){$andGroup[]=' prerozdelene_vyhry=0 ';}    
  ...
  public function PageEdit(){
    ...
    foreach($screens as $cDk=>$cDv){$screens[$cDk]->adel=$this->Anchor(array('module'=>$this->parent_module,'action'=>'tournaments-del-screen','idt'=>$idt,'idgts'=>$cDv->idgts));}
    ///
