...
class BFiles extends Module
{
    ...
    public function Main()
    {
        ...
        if ($action == 'list-files' && in_array('files_categories_view', $this->rights->povoleneKody)) {
            $this->PageListFiles();
        } elseif ($action == 'file-category-new-post' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->FileCategoryNewPost();
        } elseif ($action == 'delete-file-category' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->FileCategoryDeletePost();
        } elseif ($action == 'edit-file-category' && in_array('files_categories_view', $this->rights->povoleneKody)) {
            $this->FileCategoryEdit();
        } elseif ($action == 'file-save-category-post' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->FileCategoryEditPost();
        } elseif ($action == 'file-new-post' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->FileNewPost();
        } elseif ($action == 'save-file' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->SaveFilePost();
        } elseif ($action == 'delete-file' && in_array('files_categories_changes', $this->rights->povoleneKody)) {
            $this->DeleteFilePost();
        } elseif ($action == 'image-category-new-post' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->ImageCategoryNewPost();
        } elseif ($action == 'delete-image-category' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->ImageCategoryDeletePost();
        } elseif ($action == 'list-images' && in_array('images_categories_view', $this->rights->povoleneKody)) {
            $this->PageListImages();
        } elseif ($action == 'edit-image-category' && in_array('images_categories_view', $this->rights->povoleneKody)) {
            $this->ImageCategoryEdit();
        } elseif ($action == 'image-new-post' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->ImageNewPost();
        } elseif ($action == 'image-new-post-2' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->ImageNewPost2();
        } elseif ($action == 'delete-image' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->DeleteImagePost();
        } elseif ($action == 'save-image' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->SaveImagePost();
        } elseif ($action == 'image-save-category-post' && in_array('images_categories_changes', $this->rights->povoleneKody)) {
            $this->ImageCategoryEditPost();
        } else {
            $this->Redirect();
        }
    }
...
private function SetLeftMenu()
{
    ...
    if (getget('action', '') == 'list-files') {
        $active = 'list-files';
    }
    
    if (getget('action', '') == 'edit-file-category') {
        $active = 'list-files';
    }
    
    if (getget('action', '') == 'list-images') {
        $active = 'list-images';
    }
    
    if (getget('action', '') == 'edit-image-category') {
        $active = 'list-images';
    }
