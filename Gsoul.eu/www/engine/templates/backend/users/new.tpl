...
<table>
  ...
  <tr>
    ...
    <th>Stát</th>
    <td><input type="text" class="width-140" size="20" name="stat" maxlength="63" value="<?=$user->stat?>" /></td>
    <th>Paypal E-mail</th>
    <td colspan="3"><input type="text" class="width-110" size="20" name="email_paypal" maxlength="63" value="<?=$user->email_paypal?>" /></td>    
  </tr>  
  <tr>
    <th>Telefon</th>
