...
<?foreach($mainpages as $mp){?>
  <form action="<?=$asave;?>" method="post" autocomplete="off">
    ...
    <table>
      <tr>
        <th>Název</th>        
        <td colspan="3"><input type="text" class="width-400" size="35" name="nazev" maxlength="127" value="<?=$mp->nazev?>" /></td>
      ...
      <tr>
        ...
        <td colspan="5"><input type="text" class="width-600" size="35" name="seo_description" maxlength="255" value="<?=$mp->seo_description?>" /></td>
      </tr>
      <tr>
        <th>SEO keywords</th>
        <td colspan="5"><input type="text" class="width-600" size="35" name="seo_keywords" maxlength="255" value="<?=$mp->seo_keywords?>" /></td>
      </tr>
      <tr>
        <th>Titulek</th>
        <td colspan="5"><input type="text" class="width-600" size="35" name="seo_title" maxlength="127" value="<?=$mp->seo_title?>" /></td>      
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="6"><?=$mp->editor;?></td>
      </tr>
      <tr>
        <td colspan="4">Název stránky je povinný.</td>
