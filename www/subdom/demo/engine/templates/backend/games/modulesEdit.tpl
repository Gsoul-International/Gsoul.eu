...
<table>
  ...
  <tr><th>Hra</th><th>Maximum hráčů</th><th>Maximum kol</th><th>Poplatek za založení<br> v $ </th><th colspan="3">Procenta pro zakladatele turnaje<br /> max. 9%  </th></tr>
  <?if(count($games)!=count($usedGames)){?>
    <form method="post" action="<?=$aaddgame?>">
      <tr>
        ...
        <td><input type="text" class="width-72" name="maximalni_pocet_kol" value="1" /></td>
        <td><input type="text" class="width-140" name="poplatek_za_zalozeni_turnaje" value="0,00" /></td>
        <td><input type="text" class="width-140" name="procenta_pro_zakladatele" value="0,00" /></td>
  ...
  <?foreach($spojeni as $sx){?>
    <form method="post" action="<?=$sx->aedit?>">
      <tr>
        ...
        <td><input type="text" class="width-72" name="maximalni_pocet_kol" value="<?=$sx->maximalni_pocet_kol?>" /></td>
        <td><input type="text" class="width-140" name="poplatek_za_zalozeni_turnaje" value="<?=$sx->poplatek_za_zalozeni_turnaje?>" /></td>
        <td><input type="text" class="width-140" name="procenta_pro_zakladatele" value="<?=$sx->procenta_pro_zakladatele?>" /></td>
