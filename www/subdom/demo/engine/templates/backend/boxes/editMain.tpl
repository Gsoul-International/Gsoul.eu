...
<form action="<?=$asave;?>" method="post">
  <table>
    ...
    <tr>
      ...
      <td colspan="2"><input type="checkbox" <?if(1==$box->zobrazovat){?>checked<?}?> name="zobrazovat" value="1" /></td>    
    </tr> 
    <tr>
      <th>Zobrazovat nadpis na webu</th>
      <td colspan="2"><input type="checkbox" <?if(1==$box->zobrazovat_nadpis){?>checked<?}?> name="zobrazovat_nadpis" value="1" /></td>    
    </tr> 
    <tr>
      <th>Nadpis na webu</th>
      <td colspan="2"><input type="text" size="35" class="width-350" maxlength="127" name="nadpis" value="<?=$box->nadpis;?>" /></td>    
    </tr>               
    <tr>
