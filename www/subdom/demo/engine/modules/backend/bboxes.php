...
class BBoxes extends Module{
  ...
  public function Main(){
    ...
    $action=getget('action','list');
      ...
      elseif($action=='delete'){$this->PageDeletePost();}                  
      elseif($action=='save-order'){$this->PageSaveOrder();}                  
      elseif($action=='edit'){$this->PageEdit();}                  
      elseif($action=='edit-save'){$this->PageSaveEdit();}                  
      else{$this->Redirect();}    
    }
  ...
  private function PageEdit(){
    ...
    if($box->modul=='pages_menu'){
      $tplSub->add('sablony',array('0'=>'Jednoúrovňové menu','3'=>'Jednoúrovňové obrázkové menu'/*,'1'=>'Víceúrovňové menu - otevřené pouze aktivní stránky','2'=>'Víceúrovňové menu - otevřené všechny stránky'*/));
    ...
    if($box->modul=='gallery'){
      ...
      $tplSub->add('sablony',array('0'=>'Fotogalerie'/*,'1'=>'Partneři - fotogalerie bez odkazů','2'=>'Banner'*/));
