...
class BGameModules extends Module{
  ...
  public function PageAddGamePost(){
    ...
    $maximalni_pocet_kol=(int)getpost('maximalni_pocet_kol','');
    ...
    $this->kernel->models->DBgamesModulesVsGames->store(0,array('idmod'=>$idm,'idgam'=>$idg,'maximalni_pocet_kol'=>$maximalni_pocet_kol,'maximalni_pocet_hracu'=>$maximalni_pocet_hracu,'poplatek_za_zalozeni_turnaje'=>$poplatek_za_zalozeni_turnaje,'procenta_pro_zakladatele'=>$procenta_pro_zakladatele));      
  ...
  public function PageEditGamePost(){
    ...
    $this->kernel->models->DBgamesModulesVsGames->store($idgm,array('maximalni_pocet_kol'=>$maximalni_pocet_kol,'maximalni_pocet_hracu'=>$maximalni_pocet_hracu,'poplatek_za_zalozeni_turnaje'=>$poplatek_za_zalozeni_turnaje,'procenta_pro_zakladatele'=>$procenta_pro_zakladatele));      
