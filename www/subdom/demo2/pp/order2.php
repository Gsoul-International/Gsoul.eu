...
$id=$_GET['pid'];
$ppc=new PayPalCurl();
$access=$ppc->getAccessToken('AQAhdmNc617IELCpuuxoNyYTy4PGfSGLmebXQs76yRVGbvKboFO2WnkoC6Eg0p_7fjijeNyJSSzbiakr','EGaLJfMpg070uD-ibXho5a4hIzacM9lIoMgqjgQ3fw0neCEMoZoqYt7twwphz1SaDdXcfmj7AwiJE8Cw','tester');

$uri='v2/checkout/orders/'.$id;
$returnData=$ppc->getRequest('',$access,$uri,'tester');
var_dump($returnData);
echo $uri;
/*
