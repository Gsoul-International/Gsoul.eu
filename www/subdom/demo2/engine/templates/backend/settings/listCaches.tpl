...
<?}?>
<?if($message=='languages-regenerated'){?>
  <h2>Cache jazyků přegenerována.</h2>
<?}?>
  <table>
    <tr>
    ...
    <tr>
      <th>Cache jazyků</th>
      <td>Poslední vygenerování: <?=$languagesTime;?></td>
      <td align="right"><a href="<?=$aLanguagesRegenerate;?>">Přegenerovat cache <i class="fa fa-arrow-right"></i></a></td>
    </tr>
  </table>
<br /><br />
<div class="BackendHelp">
  ...
  <div class="BackendHelpBody" id="BackendHelp">    
      ...
      <br /> <br />
      Cache jazyků: V této cache jsou uloženy všechny údaje o jazykových mutacích webu. Díky této cache systém rychleji načítá překlady na webu.    
  </div>
</div>
