...
<table>
  ...
  <tr>
    ...
    <td colspan="3"><input type="checkbox" id="osloveni" name="osloveni" value="1" checked /></td>        
  </tr>
</table>
<p>
...
<table>
  <tr>
    <th><label for="e_uzivatele">S právy uživatel</label></th>
    <td><input type="checkbox" id="e_uzivatele" name="e_uzivatele" value="1" checked /></td>
    <th><label for="e_admini">S právy administrátor</label></th>
    <td><input type="checkbox" id="e_admini" name="e_admini" value="1" checked /></td>
  </tr>  
  <tr>
    <th><label for="e_super">S právy superadministrátor</label></th>
