...
class BGameModules extends Module {
    ...
    public function PageEdit() {
        ...
        if (!isset($data->idm) || $data->idm < 1) {
            $this->redirect(array('module' => $this->parent_module, 'action' => 'modules', 'message' => 'not-found'), false);
        }
    ...
    public function PageAddGamePost() {
        ...
        if ($procenta_pro_zakladatele > 9) {
            $procenta_pro_zakladatele = 9;
        }
    ...
    public function PageEditGamePost() {
        ...
        if ($idgm < 1) {
            $this->redirect(array('module' => $this->parent_module, 'action' => 'modules-edit', 'message' => 'not-found', 'idm' => $idm), false);
        }
