...
class DBrewrites extends Model {
    ...
    public function AddEditRewrite($nice_url = '', $module = '', $item_id_name = '', $item_id = 0, $mainPage = false) {
        if ($mainPage == false) {
            ...
            $system_url = '/?module=' . str_replace(array('FTournaments2', 'FTournaments3', 'FCups2', 'FCups3'), array('FTournaments', 'FTournaments&action=tournament-view', 'FCups', 'FCups&action=cup-view'), $module) . '&' . $item_id_name . '=' . $item_id;
